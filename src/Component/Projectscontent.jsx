    ...
    <>
      <div className="projects-content">
          <div className="content px-4 py-5 dark:bg-sd dark:text-white">
            ...
            <div className="main-cards-container relative project-card mt-6 flex flex-wrap justify-between gap-y-4">
              <div className="main-card dark:bg-md projects-card  card-one relative rounded-2xl bg-white p-6">
                ...
                <div className="flex justify-between mt-6 mb-4">
                    <div className="relative  w-36 h-3 rounded-lg bg-gray-400">
                        <div className="absolute h-full rounded-lg left-0 w-3/4 bg-mb"></div>
                    </div>
                    <div className="flex gap-1 text-gray-500 font-bold items-center">
                                    <MdOutlineAttachMoney className="text-xl"/>
                                    <p>25</p>
                    </div>
                </div>
                <p className="absolute right-4 text-gray-500 text-sm top-4">15/10/2021</p>
              </div>
              <div className="main-card dark:bg-md projects-card  card-one relative rounded-2xl bg-white p-6">
              ...
              <div className="main-card dark:bg-md projects-card  card-one relative rounded-2xl bg-white p-6">
                ...
                <div className="flex justify-between mt-6 mb-4">
                    <div className="relative  w-36 h-3 rounded-lg bg-gray-400">
                        <div className="absolute h-full rounded-lg left-0 w-1/2 bg-green-500"></div>
                    </div>
                    <div className="flex gap-1 text-gray-500 font-bold items-center">
                                    <MdOutlineAttachMoney className="text-xl"/>
                                    <p>25</p>
              ...
              <div className="main-card dark:bg-md projects-card  card-one relative rounded-2xl bg-white p-6">
                ...
                <div className="flex justify-between mt-6 mb-4">
                    <div className="relative  w-36 h-3 rounded-lg bg-gray-400">
                        <div className="absolute h-full rounded-lg left-0 w-1/4 bg-red-500"></div>
                    </div>
                    <div className="flex gap-1 text-gray-500 font-bold items-center">
                                    <MdOutlineAttachMoney className="text-xl"/>
                                    <p>25</p>
