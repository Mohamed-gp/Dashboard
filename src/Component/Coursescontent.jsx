                ...
                <div className="main-cards-container mt-6 flex flex-wrap justify-between gap-y-4">
                    <div className="main-card dark:bg-md text-center md:text-left bg-white  pb-4 rounded-lg relative">
                        ...
                        <div className="p-4 flex flex-col gap-2">
                            ...
                            <p className="font-bold dark:text-white">Mastering Web Design</p>
                    ...
                    <div className="main-card dark:bg-md text-center md:text-left bg-white  pb-4 rounded-lg relative">
                        ...
                        <div className="p-4 flex flex-col gap-2">
                            ...
                            <p className="font-bold dark:text-white">Data Structure And Algorithms</p>
                    ...
                    <div className="main-card dark:bg-md text-center md:text-left bg-white  pb-4 rounded-lg relative">
                        ...
                        <div className="p-4 flex flex-col gap-2">
                            ...
                            <p className="font-bold dark:text-white">Responsive Web Design</p>
